...
import comp1 from '../../media/caroline/game-dev/comp1.jpg';
import comp2 from '../../media/caroline/game-dev/comp2.jpg';
import comp3 from '../../media/caroline/game-dev/comp3.jpg';
import tos1 from '../../media/caroline/game-dev/tos1.jpg';
import tos2 from '../../media/caroline/game-dev/tos2.jpg';
import tos3 from '../../media/caroline/game-dev/tos3.jpg';
import tos4 from '../../media/caroline/game-dev/tos4.jpg';
        ...
        return (
            <Grid container spacing={3}>
                ...
                <Grid item xs={12} lg={4}>
                    <img className="photo" src={comp1} width="400px" height="250px" />
                    <br /><br /><br />
                    <img className="photo" src={comp2} width="400px" height="250px" />
                    <br /><br /><br />
                    <img className="photo" src={comp3} width="400px" height="250px" />
                </Grid>
